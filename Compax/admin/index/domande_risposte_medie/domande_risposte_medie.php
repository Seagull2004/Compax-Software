        ...
        <script>
          function createInputFields() 
          {
            ...
            for (var i = 1; i <= numRisposte; i++) {
              ...
              inputFields.innerHTML += '<div class="my-1"><label for="punti_liceo_sportivo' + i + '">Punti Liceo Sportivo:</label><input class="ml-5 border border-gray-400 rounded-md p-1 w-1/6" type="number" id="punti_liceo_sportivo' + i + '" name="punti_liceo_sportivo' + i + '"></div>';
              inputFields.innerHTML += '<div class="my-1"><label for="punti_conservatorio' + i + '">Punti Conservatorio:</label><input class="ml-5 border border-gray-400 rounded-md p-1 w-1/6" type="number" id="punti_conservatorio' + i + '" name="punti_conservatorio' + i + '"></div>';
              inputFields.innerHTML += '<div class="my-1"><label for="punti_istituto_professionale' + i + '">Punti Istituto Professionale:</label><input class="ml-5 border border-gray-400 rounded-md p-1 w-1/6" type="number" id="punti_istituto_professionale' + i + '" name="punti_istituto_professionale' + i + '"></div>';
              inputFields.innerHTML += '<div class="my-1"><label for="punti_istituto_tecnico' + i + '">Punti Istituto Tecnico:</label><input class="ml-5 border border-gray-400 rounded-md p-1 w-1/6" type="number" id="punti_istituto_tecnico' + i + '" name="punti_istituto_tecnico' + i + '"></div>';
              inputFields.innerHTML += '<div class="my-1"><label for="punti_liceo_scientifico' + i + '">Punti Liceo Scientifico:</label><input class="ml-5 border border-gray-400 rounded-md p-1 w-1/6" type="number" id="punti_liceo_scientifico' + i + '" name="punti_liceo_scientifico' + i + '"></div>';
              inputFields.innerHTML += '<div class="my-1"><label for="punti_liceo_classico' + i + '">Punti Liceo Classico:</label><input class="ml-5 border border-gray-400 rounded-md p-1 w-1/6" type="number" id="punti_liceo_classico' + i + '" name="punti_liceo_classico' + i + '"></div>';
              inputFields.innerHTML += '<div class="my-1"><label for="punti_scienze_umane' + i + '">Punti Scienze Umane:</label><input class="ml-5 border border-gray-400 rounded-md p-1 w-1/6" type="number" id="punti_scienze_umane' + i + '" name="punti_scienze_umane' + i + '"></div>';
              inputFields.innerHTML += '<div class="my-1"><label for="punti_istituto_tecnico_turistico' + i + '">Punti Istituto Tecnico Turistico:</label><input class="ml-5 border border-gray-400 rounded-md p-1 w-1/6" type="number" id="punti_istituto_tecnico_turistico' + i + '" name="punti_istituto_tecnico_turistico' + i + '"></div>';
              inputFields.innerHTML += '<div class="my-1"><label for="punti_professionale_sociale' + i + '">Punti Professionale Sociale:</label><input class="ml-5 border border-gray-400 rounded-md p-1 w-1/6" type="number" id="punti_professionale_sociale' + i + '" name="punti_professionale_sociale' + i + '"></div>';
              inputFields.innerHTML += '<div class="my-1"><label for="punti_liceo_linguistico' + i + '">Punti Liceo Linguistico:</label><input class="ml-5 border border-gray-400 rounded-md p-1 w-1/6" type="number" id="punti_liceo_linguistico' + i + '" name="punti_liceo_linguistico' + i + '"></div>'
